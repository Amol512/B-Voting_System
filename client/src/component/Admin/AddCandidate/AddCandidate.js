// this file is responsible for add new candidates for election.
// a task is done by admin only. admin can add candidates 
...
export default class AddCandidate extends Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      // Set web3, accounts, and contracts.
      this.setState({
        web3: web3,
  ...
  addCandidate = async () => {
    await this.state.ElectionInstance.methods.addCandidate(this.state.header, this.state.party).send({ from: this.state.account, gas: 1000000 });
    window.location.reload();
  };
