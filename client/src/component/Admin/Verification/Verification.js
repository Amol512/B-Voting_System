// Voter's registered himself/herself for voting and after admin has to verify
// those voter's who wants to vote in ongoing election
...
export default class Registration extends Component {
  ...
  renderUnverifiedVoters = (voter) => {
    const verifyVoter = async (verifiedStatus, address) => {
      await this.state.ElectionInstance.methods.verifyVoter(verifiedStatus, address).send({ from: this.state.account, gas: 1000000 });
      window.location.reload();
    };
    return (
      <>
