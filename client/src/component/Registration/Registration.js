// code contained registration form for voter's who wants to vote in election
// voter have to registered itself and wait till the admin verify them 
// Admin also can Registered itself for voting
...
export default class Registration extends Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      // Catch errors for any of the above operations.
      console.error(error);
  ...
  registerAsVoter = async () => {
    await this.state.ElectionInstance.methods.registerAsVoter(this.state.voterName, this.state.voterPhone).send({ from: this.state.account, gas: 1000000 });
    window.location.reload();
  };
  render() {
    if (!this.state.web3) {
